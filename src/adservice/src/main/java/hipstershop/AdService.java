...
public final class AdService {
  ...
  static final Counter exampleHttpRequestsSuccess = Counter.build()
  ...
  public static class AdServiceImpl extends hipstershop.AdServiceGrpc.AdServiceImplBase {
    ...
    public void getAds(AdRequest req, StreamObserver<AdResponse> responseObserver) {
      ...
      try {
        ...
        exampleHttpRequestsSuccess.inc();
      } catch (StatusRuntimeException e) {
        logger.log(Level.WARN, "GetAds Failed", e.getStatus());
        exampleHttpRequestsFail.inc();
  ...
  public static ImmutableListMultimap<String, Ad> createAdsMap() {
    ...
    Ad lens =
        Ad.newBuilder()
            ...
            .setText("Vintage camera lens for sale. 50% off.")
            .build();
    Ad recordPlayer =
        Ad.newBuilder()
